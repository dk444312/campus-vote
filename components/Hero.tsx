...
const Hero: React.FC = () => {
  // Voting starts: 21 November 2025, 6:00 AM CAT (Central Africa Time)
    ...
    <section className="relative min-h-screen bg-gradient-to-br from-[#003087] via-[#004099] to-[#0050b3] overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-24 md:py-32">
        <div className="text-center">
          ...
          {/* Countdown Box - Only shows before voting starts */}
          {!isVotingOpen && (
          ...
          <div className="mt-16">
            ...
            >
              {isVotingOpen ? 'Start Voting Now' : 'Voting Starts in...'}
            </a>
          </div>
          ...
          <p className="mt-10 max-w-2xl mx-auto text-blue-100 text-lg md:text-xl font-light leading-relaxed">
            {isVotingOpen
              ? 'The polls are now open! Cast your vote for the next generation of student leaders.'
              : 'Prepare to make your voice heard. Every vote counts at The Catholic University of Malawi.'}
          </p>
        </div>
      </div>

      {/* CUNIMA Seal / Decorative Element */}
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 text-white/10 text-9xl font-bold select-none pointer-events-none">
        CUNIMA
      </div>
    </section>
  );
